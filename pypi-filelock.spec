...
Source0  : https://files.pythonhosted.org/packages/08/dd/49e06f09b6645156550fb9aee9cc1e59aba7efbc972d665a1bd6ae0435d4/filelock-3.15.4.tar.gz
...
%prep
%setup -q -n filelock-3.15.4
cd %{_builddir}/filelock-3.15.4
pushd ..
cp -a filelock-3.15.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719248684
