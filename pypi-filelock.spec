...
Source0  : https://files.pythonhosted.org/packages/e6/76/3981447fd369539aba35797db99a8e2ff7ed01d9aa63e9344a31658b8d81/filelock-3.16.0.tar.gz
...
%prep
%setup -q -n filelock-3.16.0
cd %{_builddir}/filelock-3.16.0
pushd ..
cp -a filelock-3.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725727694
