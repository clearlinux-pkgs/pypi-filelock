...
Source0  : https://files.pythonhosted.org/packages/0b/dc/eac02350f06c6ed78a655ceb04047df01b02c6b7ea3fc02d4df24ca87d24/filelock-3.9.0.tar.gz
...
%prep
%setup -q -n filelock-3.9.0
cd %{_builddir}/filelock-3.9.0
pushd ..
cp -a filelock-3.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672330247
