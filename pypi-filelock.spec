...
Version  : 3.5.1
Release  : 35
URL      : https://files.pythonhosted.org/packages/4c/0a/54d0bd2f406da3570b33d1a798a6bfb8259728459a46ed01206cc9ed4098/filelock-3.5.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/4c/0a/54d0bd2f406da3570b33d1a798a6bfb8259728459a46ed01206cc9ed4098/filelock-3.5.1.tar.gz
...
%prep
%setup -q -n filelock-3.5.1
cd %{_builddir}/filelock-3.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645042047
...
cp %{_builddir}/filelock-3.5.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-filelock/24944bf7920108f5a4790e6071c32e9102760c37
