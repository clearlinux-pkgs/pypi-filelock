...
Source0  : https://files.pythonhosted.org/packages/4f/1f/6e1b740698069650b245744957a25957d599b953550a959ab2a584a8825b/filelock-3.10.0.tar.gz
...
%prep
%setup -q -n filelock-3.10.0
cd %{_builddir}/filelock-3.10.0
pushd ..
cp -a filelock-3.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678977540
