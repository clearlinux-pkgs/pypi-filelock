...
Source0  : https://files.pythonhosted.org/packages/69/7d/73d36db6955bde2ed495ce40ce02c9a2533b8c7b64fd42a38b1ee879ea18/filelock-3.15.1.tar.gz
...
%prep
%setup -q -n filelock-3.15.1
cd %{_builddir}/filelock-3.15.1
pushd ..
cp -a filelock-3.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718296088
