...
Source0  : https://files.pythonhosted.org/packages/7d/98/6e68cf474669042ba6ba0a7761b8be04beb8131b366d5c6b1596f8cdfec2/filelock-3.15.3.tar.gz
...
%prep
%setup -q -n filelock-3.15.3
cd %{_builddir}/filelock-3.15.3
pushd ..
cp -a filelock-3.15.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718821006
