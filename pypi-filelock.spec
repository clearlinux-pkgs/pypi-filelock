...
Source0  : https://files.pythonhosted.org/packages/06/ae/f8e03746f0b62018dcf1120f5ad0a1db99e55991f2cda0cf46edc8b897ea/filelock-3.14.0.tar.gz
...
%prep
%setup -q -n filelock-3.14.0
cd %{_builddir}/filelock-3.14.0
pushd ..
cp -a filelock-3.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714433972
