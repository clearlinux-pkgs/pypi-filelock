...
Source0  : https://files.pythonhosted.org/packages/38/ff/877f1dbe369a2b9920e2ada3c9ab81cf6fe8fa2dce45f40cad510ef2df62/filelock-3.13.4.tar.gz
...
%prep
%setup -q -n filelock-3.13.4
cd %{_builddir}/filelock-3.13.4
pushd ..
cp -a filelock-3.13.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712764243
