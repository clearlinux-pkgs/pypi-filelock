...
Source0  : https://files.pythonhosted.org/packages/4d/cd/3b1244a19d61c4cf5bd65966eef97e6bc41e51fe84110916f26554d6ac8c/filelock-3.6.0.tar.gz
...
%prep
%setup -q -n filelock-3.6.0
cd %{_builddir}/filelock-3.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645212213
...
cp %{_builddir}/filelock-3.6.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-filelock/24944bf7920108f5a4790e6071c32e9102760c37
