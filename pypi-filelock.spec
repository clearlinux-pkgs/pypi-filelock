...
Source0  : https://files.pythonhosted.org/packages/db/97/3f028f216da17ab0500550a6bb0f26bf39b07848348f63cce44b89829af9/filelock-3.13.3.tar.gz
...
%prep
%setup -q -n filelock-3.13.3
cd %{_builddir}/filelock-3.13.3
pushd ..
cp -a filelock-3.13.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711405644
