...
Source0  : https://files.pythonhosted.org/packages/dc/9c/0b15fb47b464e1b663b1acd1253a062aa5feecb07d4e597daea542ebd2b5/filelock-3.17.0.tar.gz
...
%prep
%setup -q -n filelock-3.17.0
cd %{_builddir}/filelock-3.17.0
pushd ..
cp -a filelock-3.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737495934
