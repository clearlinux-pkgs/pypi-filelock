...
Source0  : https://files.pythonhosted.org/packages/26/25/b1afa817675554ee17f392cae6a5783307448bd8f26d677449b9b8bbab20/filelock-3.9.1.tar.gz
...
%prep
%setup -q -n filelock-3.9.1
cd %{_builddir}/filelock-3.9.1
pushd ..
cp -a filelock-3.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678890592
